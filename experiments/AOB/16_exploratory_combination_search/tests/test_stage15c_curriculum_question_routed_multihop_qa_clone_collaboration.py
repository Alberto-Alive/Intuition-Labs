...
MODULE_PATH = (
    ...
    / "src"
    / "experiments"
    / "run_stage15c_curriculum_question_routed_multihop_qa_clone_collaboration.py"
)
SPEC = importlib.util.spec_from_file_location("stage15c_curriculum_question_routed_multihop_qa_clone_collaboration", MODULE_PATH)
