...
"$py" train.py --config configs/memory_slot_attention.yaml
"$py" train.py --config configs/slot_alignment_loss.yaml
"$py" train.py --config configs/predictive_slot_residual.yaml
"$py" train.py --config configs/mirrored_slot_attention.yaml
