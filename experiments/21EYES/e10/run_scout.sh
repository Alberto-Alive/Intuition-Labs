...
"$py" train.py --config configs/shared_subspace_crossing.yaml
"$py" train.py --config configs/gated_subspace_crossing.yaml
"$py" train.py --config configs/superposition_crossing.yaml
"$py" train.py --config configs/rotation_crossing.yaml
"$py" train.py --config configs/pairwise_crossing.yaml
"$py" train.py --config configs/crossing_every_2_layers.yaml
"$py" train.py --config configs/crossing_every_layer.yaml
