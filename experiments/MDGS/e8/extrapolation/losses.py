"""Loss functions for the DIGIT Extrapolation E8 diffusion variant.

E8 keeps the E6 diffusion-owned outcome path and adds:
...
class DIGITLoss(nn.Module):
    """Combined loss for the E8 diffusion + prototype geometry scaffold."""
    ...
    def _family_supervision_loss(
        ...
        return ce_loss + 0.75 * margin_loss + 0.25 * top_family_mismatch
