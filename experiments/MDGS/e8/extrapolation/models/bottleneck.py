"""Diffusion-owned certainty/outcome bottleneck for DIGIT Extrapolation E8.
...
class DiffusionBottleneckHead(nn.Module):
    """Diffusion-based epistemic bottleneck for E8."""
    ...
    def __init__(
        ...
        **_kwargs,
        ...
        self.fragility_head = DiffusionFragilityHead(
            input_dim=DiffusionTrustHead.STATS_DIM + 14,
