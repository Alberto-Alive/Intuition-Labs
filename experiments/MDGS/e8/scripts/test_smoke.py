"""Smoke test for the DIGIT Extrapolation E8 package."""
...
assert hasattr(model.bottleneck, "prototype_bank"), "E8 should expose a diffusion-native prototype bank"
assert hasattr(model.bottleneck, "fragility_head"), "E8 should expose a fragility head"
