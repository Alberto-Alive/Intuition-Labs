"""Witness-agreement statistics and readout modules for E30."""
...
class WitnessAgreementReadout(nn.Module):
    """Implements the strict E30 decision rule from witness agreement only."""
    ...
    def summarize(
        ...
        *,
        ...
        if self.use_coherence_weighting:
            ...
            witness_weights = F.softmax(coherence_scores / temperature, dim=-1)
        else:
    ...
    def forward(self, stats: WitnessSetStats) -> WitnessReadoutResult:
        ...
        commitment_score = stats.margin_abs - lambda_commit * uncertainty
