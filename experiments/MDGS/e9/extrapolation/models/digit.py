"""Full DIGIT Extrapolation E9 model with diffusion + prototype geometry."""
...
class DIGITModel(nn.Module):
    """End-to-end DIGIT model with diffusion-owned outcome and basin-shaped prototype geometry."""
