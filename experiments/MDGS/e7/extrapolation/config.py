"""Configuration dataclass for the DIGIT Extrapolation E7 experiment."""
...
class Config:
    ...
    # ── Diffusion bottleneck + prototype geometry (E7) ───────────────────────
    ...
    # Auxiliary E7 losses.
    lambda_prototype_alignment: float = 0.15
    lambda_perturbation_rank: float = 0.20
