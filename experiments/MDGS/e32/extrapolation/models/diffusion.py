"""Conditional latent diffusion modules for E31."""
...
class ConditionalLatentDiffusion(nn.Module):
    ...
    def sample_trajectory(
        ...
        *,
        ...
        """Return the reverse-diffusion trajectory as [steps, samples, batch, latent]."""
        ...
        trajectory = []
        if include_initial:
            trajectory.append(z_t.reshape(num_samples, batch_size, latent_dim))
