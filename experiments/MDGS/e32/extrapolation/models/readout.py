...
def bucketize_commitment_decisions(
    global_margin: torch.Tensor,
    commitment_score: torch.Tensor,
    threshold: torch.Tensor,
) -> torch.Tensor:
    """Commit if the score clears the threshold, otherwise abstain as UNCERTAIN."""

    uncertain_mask = commitment_score < threshold
...
def bucketize_hard_commitment_decisions(
    ...
    return bucketize_commitment_decisions(global_margin, commitment_score, tau_uncertain)
