"""Configuration for the E32 cooperative path/witness uncertainty experiment."""
...
@dataclass
class E31Config:
    """Standalone E32 config with the fields used by the local experiment."""
    ...
    enable_disturbance_profile: bool = False
    disturbance_num_samples: int = 8
    disturbance_noise_std: float = 0.05
    enable_boundary_probe: bool = True
    enable_feature_mask_probe: bool = True
    enable_learned_probe: bool = False
    disturbance_feature_mask_prob: float = 0.15
    disturbance_boundary_epsilon: float = 0.10
    disturbance_profile_hidden_dim: int = 128
    disturbance_profile_dropout: float = 0.1
    disturbance_learned_hidden_dim: int = 128
    detach_profile_from_base: bool = True
    ...
    target_commit_rate_min: float = 0.20
    target_commit_rate_max: float = 0.80
    profile_loss_weight: float = 0.05
    risk_loss_weight: float = 1.0
    risk_target_mode: str = "incorrect_only"
