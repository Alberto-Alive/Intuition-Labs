...
from extrapolation.trace_pipeline import ensure_trace_corpus, evaluate_trace_baselines, set_global_determinism
...
def _reference_metrics_path(trace_dir: Path) -> Path:
    return trace_dir / "reference_metrics.v3.json"
...
def _maybe_write_reference_metrics(
    ...
    if trace_info.get("label_version") != "v3":
        return False
...
def main() -> None:
    ...
    print("DIGIT Extrapolation trace-driven run")
