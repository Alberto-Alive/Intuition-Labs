"""Trace-driven staged training and evaluation for DIGIT Extrapolation E6 (diffusion bottleneck)."""
...
def _anchor_geometry_from_model(model: DIGITModel) -> dict[str, Any]:
    # E6 no longer learns private latent worsening directions.
    return {"variant": "diffusion_e6"}
